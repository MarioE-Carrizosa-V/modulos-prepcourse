...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   if (objetoUsuario['email'] === undefined || objetoUsuario['email'] === null) return false; 
   else {
   return true
   }
}
...
function agregarAmigo(objetoUsuario, nuevoAmigo) {
   ...
   // Retornar el objeto.
   // Tu código:
   var nuevalista = objetoUsuario['amigos']
   nuevalista.push(nuevoAmigo)
   return objetoUsuario
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto['calcularPrecioDescuento'] = function() {
      ...
      return objetoProducto.precio - costo
   }
